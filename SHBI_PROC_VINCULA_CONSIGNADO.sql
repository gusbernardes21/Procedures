ALTER PROCEDURE SHBI_PROC_VINCULA_CONSIGNADO 
AS  
BEGIN  


DECLARE @iQtdeDias       INT          = NULL 
  ...
  SELECT TOP 1   @iQtdeDias = VALOR
    FROM SHBI_TAB_CONSIGNADO_PARAM 
  WHERE PARAMETRO = '<DIAS>'
 ...
 DELETE  WAREHOUSE..SHBI_TAB_CONSIGNADO               
 DELETE  WAREHOUSE..SHBI_TAB_CONSIGNADO_NF            
 DELETE  WAREHOUSE..SHBI_TAB_CONSIGNADO_TICKET       
